...
namespace GFS.Domain
{
    public class Data
    {
        ...
        public IEnumerable<User> users()
        {
            ...
            if (!users.Any())
            {
                users.Add(new User { userid = "1234567890987", Id = 1, firstname = "Admin", lastname = "Admin", CustEmail = "admin@admin.co.za", user = "Admin", password = "12345", ConfirmPassword = "12345", estatus = true, RememberMe = true });
            }
